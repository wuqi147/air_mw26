...
typedef enum
{
    AIR_PERIF_GPIO_DIRECTION_INPUT = 0,
    AIR_PERIF_GPIO_DIRECTION_OUTPUT,
    AIR_PERIF_GPIO_DIRECTION_LAST
} AIR_PERIF_GPIO_DIRECTION_T;

typedef enum
{
    AIR_PERIF_GPIO_DATA_LOW = 0,
    AIR_PERIF_GPIO_DATA_HIGH,
    AIR_PERIF_GPIO_DATA_LAST
} AIR_PERIF_GPIO_DATA_T;

typedef enum
{
    AIR_PERIF_GPIO_PATT_HZ_HALF = 0,
    AIR_PERIF_GPIO_PATT_HZ_ONE,
    AIR_PERIF_GPIO_PATT_HZ_TWO,
    AIR_PERIF_GPIO_PATT_HZ_EIGHT,
    AIR_PERIF_GPIO_PATT_LAST
