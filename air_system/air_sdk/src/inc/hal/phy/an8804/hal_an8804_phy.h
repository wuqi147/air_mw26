...
/* FILE NAME:  hal_an8804_phy.h
 * PURPOSE:
 *      Define AN8804 driver function
 *
 * NOTES:
 *
 */

#ifndef HAL_AN8804_PHY_H
#define HAL_AN8804_PHY_H
...
#define HAL_AN8804_PHY_SLED_SRC_SEL_REG        (0x1021C02C)
#define HAL_AN8804_PHY_CYCLE_CFG_VALUE1_REG    (0x1000A39C)
#define HAL_AN8804_PHY_GPIO_FLASH_PRD_SET2_REG (0x1000A344)
#define HAL_AN8804_PHY_LED_FLASH_SET_CTRL0_REG (0x1021C030)
#define HAL_AN8804_PHY_GPIO_FLASH_MODE_REG     (0x1000A334)
#define HAL_AN8804_PHY_GPIO_FLASH_CFG0_REG     (0x1000A34C)
#define HAL_AN8804_PHY_GPIO_OE_REG             (0x1000A314)
#define HAL_AN8804_PHY_GPIO_L_INV_REG          (0x10000010)
#define HAL_AN8804_PHY_LAN_LED_IOMUX_REG       (0x10000054)
#define HAL_PHY_DEVICE_ID_AN8804               (0xc0ff0410)

#define HAL_AN8804_PHY_SGMII_AN0           (0x10220000)
#define HAL_AN8804_PHY_SGMII_AN4           (0x10220010)
#define HAL_AN8804_PHY_PCS_CTRL1           (0x10220a00)
#define HAL_AN8804_PHY_PCS_STS             (0x10220b04)
#define HAL_AN8804_PHY_EFIFO_MODE          (0x10270100)
#define HAL_AN8804_PHY_EFIFO_CTRL          (0x10270104)
#define HAL_AN8804_PHY_EFIFO_WM            (0x10270108)
#define HAL_AN8804_PHY_SGMII_AN0_ANRESTART (0x0200) /* Serdes auto negotation restart */
#define HAL_AN8804_PHY_SGMII_AN0_AN_DONE   (0x0001)
#define HAL_AN8804_PHY_SGMII_AN0_RESET     (0x8000)

/* chip control register */
#define HAL_AN8804_PHY_RG_GPIO_LED_INV        (0x10000010)
#define HAL_AN8804_PHY_RG_GPIO_DRIVING_E2     (0x10000018)
#define HAL_AN8804_PHY_RG_GPIO_LAN0_LED0_MODE (0x10000054)
#define HAL_AN8804_PHY_RG_GPIO_LAN0_LED0_SEL  (0x10000058)
#define HAL_AN8804_PHY_RG_FORCE_GPIO0_EN      (0x1000007C)

/* LED Behavior */
#define HAL_AN8804_PHY_LED_BHV_LINK_1000     (0x0001)
#define HAL_AN8804_PHY_LED_BHV_LINK_100      (0x0002)
#define HAL_AN8804_PHY_LED_BHV_LINK_10       (0x0004)
#define HAL_AN8804_PHY_LED_BHV_LINK_FULLDPLX (0x0008)
#define HAL_AN8804_PHY_LED_BHV_LINK_HALFDPLX (0x0010)
#define HAL_AN8804_PHY_LED_BHV_BLINK_TX_1000 (0x0020)
#define HAL_AN8804_PHY_LED_BHV_BLINK_RX_1000 (0x0040)
#define HAL_AN8804_PHY_LED_BHV_BLINK_TX_100  (0x0080)
#define HAL_AN8804_PHY_LED_BHV_BLINK_RX_100  (0x0100)
#define HAL_AN8804_PHY_LED_BHV_BLINK_TX_10   (0x0200)
#define HAL_AN8804_PHY_LED_BHV_BLINK_RX_10   (0x0400)
#define HAL_AN8804_PHY_LED_BHV_HIGH_ACTIVE   (0x0800)

/* LED Link register */
#define HAL_AN8804_PHY_LED_LINK_1000     (0x0001)
#define HAL_AN8804_PHY_LED_LINK_100      (0x0002)
#define HAL_AN8804_PHY_LED_LINK_10       (0x0004)
#define HAL_AN8804_PHY_LED_LINK_DOWN     (0x0008)
#define HAL_AN8804_PHY_LED_LINK_FULLDPLX (0x0010)
#define HAL_AN8804_PHY_LED_LINK_HALFDPLX (0x0020)
#define HAL_AN8804_PHY_LED_LINK_FORCE_ON (0x0040)
#define HAL_AN8804_PHY_LED_POL_HIGH_ACT  (0x4000)
#define HAL_AN8804_PHY_LED_FUNC_ENABLE   (0x8000)

/* LED Blink register */
#define HAL_AN8804_PHY_LED_BLINK_TX_1000       (0x0001)
#define HAL_AN8804_PHY_LED_BLINK_RX_1000       (0x0002)
#define HAL_AN8804_PHY_LED_BLINK_TX_100        (0x0004)
#define HAL_AN8804_PHY_LED_BLINK_RX_100        (0x0008)
#define HAL_AN8804_PHY_LED_BLINK_TX_10         (0x0010)
#define HAL_AN8804_PHY_LED_BLINK_RX_10         (0x0020)
#define HAL_AN8804_PHY_LED_BLINK_COLLISION     (0x0040)
#define HAL_AN8804_PHY_LED_BLINK_RX_CRC_ERROR  (0x0080)
#define HAL_AN8804_PHY_LED_BLINK_RX_IDLE_ERROR (0x0100)
#define HAL_AN8804_PHY_LED_BLINK_FORCE         (0x0200)

/* LED Register */
#define HAL_AN8804_PHY_LED_COUNT          (2)
#define HAL_AN8804_PHY_LED_0_ON_MASK      (0x03e0)
#define HAL_AN8804_PHY_LED_0_BLK_MASK     (0x03e1)
#define HAL_AN8804_PHY_LED_1_ON_MASK      (0x03e2)
#define HAL_AN8804_PHY_LED_1_BLK_MASK     (0x03e3)
#define HAL_AN8804_PHY_LED_2_ON_MASK      (0x03e4)
#define HAL_AN8804_PHY_LED_2_BLK_MASK     (0x03e5)
#define HAL_AN8804_PHY_LED_3_ON_MASK      (0x03e6)
#define HAL_AN8804_PHY_LED_3_BLK_MASK     (0x03e7)
#define HAL_AN8804_PHY_LED_CTRL_SELECT    (0x03e8)
#define HAL_AN8804_PHY_LED_0_ON_DURATION  (0x03e9)
#define HAL_AN8804_PHY_LED_0_BLK_DURATION (0x03ea)
#define HAL_AN8804_PHY_LED_1_ON_DURATION  (0x03eb)
#define HAL_AN8804_PHY_LED_1_BLK_DURATION (0x03ec)
#define HAL_AN8804_PHY_LED_2_ON_DURATION  (0x03ed)
#define HAL_AN8804_PHY_LED_2_BLK_DURATION (0x03ee)
#define HAL_AN8804_PHY_LED_3_ON_DURATION  (0x03ef)
#define HAL_AN8804_PHY_LED_3_BLK_DURATION (0x03f0)

#define HAL_AN8804_PHY_LED_CFG_RG_OFFSET       (0x0004)
#define HAL_AN8804_PHY_LED_0_CFG_CTRL_MODE_BIT (0x0000)
#define HAL_AN8804_PHY_LED_CFG_CTRL_MODE_WIDTH (0x0001)
#define HAL_AN8804_PHY_LED_CFG_CTRL_MODE_MASK  (0x0001)
#define HAL_AN8804_PHY_LED_0_CFG_STATE_BIT     (0x0001)
#define HAL_AN8804_PHY_LED_CFG_STATE_WIDTH     (0x0002)
#define HAL_AN8804_PHY_LED_CFG_STATE_MASK      (0x0003)
#define HAL_AN8804_PHY_LED_0_CFG_PATT_BIT      (0x0003)
#define HAL_AN8804_PHY_LED_CFG_PATT_WIDTH      (0x0002)
#define HAL_AN8804_PHY_LED_CFG_PATT_MASK       (0x0003)

#define HAL_AN8804_PHY_LED_ON_RATE_DEFAULT    (0x0600)
#define HAL_AN8804_PHY_LED_BLINK_RATE_DEFAULT (0x0C00)
#define HAL_AN8804_PHY_LED_BLINK_RATE_HZ_HALF (0xBEBE)
#define HAL_AN8804_PHY_LED_BLINK_RATE_HZ_ONE  (0x5F5F)
#define HAL_AN8804_PHY_LED_BLINK_RATE_HZ_TWO  (0x2FB0)

#define HAL_AN8804_PHY_LPBK_FAR_END (0x8000)

/* Wave-Gen pattern */
#define HAL_AN8804_PHY_WAVE_GEN_CYCLE_567 (0xffffff00) /* for 250Hz cycle */
#define HAL_AN8804_PHY_WAVE_GEN_CYCLE_MAX (0xff)
#define HAL_AN8804_PHY_WAVE_GEN_CYCLE_MIN (0x00)
#define HAL_AN8804_PHY_PATTERN_ON         (0xff00)
#define HAL_AN8804_PHY_PATTERN_OFF        (0x00ff)
#define HAL_AN8804_PHY_PATTERN_HZ_HALF    (0xfafa)
#define HAL_AN8804_PHY_PATTERN_HZ_ONE     (0x7d7d)
#define HAL_AN8804_PHY_PATTERN_HZ_TWO     (0x3e3e)
#define HAL_AN8804_PHY_PATTERN_HZ_ZERO    (0x0000)

#define HAL_AN8804_PHY_FLASH_MAP_ID_PATT_0        (0x00ee)
#define HAL_AN8804_PHY_FLASH_MAP_ID_PATT_1        (0x00ff)
#define HAL_AN8804_PHY_FLASH_MAP_ID_PATT_PARALLEL (0xeeeeeeee)
#define HAL_AN8804_PHY_FLASH_MAP_ID_OFF           (0x00cc)
#define HAL_AN8804_PHY_FLASH_MAP_ID_ON            (0x00dd)

#define HAL_AN8804_PHY_LED_TYPE_PARALLEL (1)
#define HAL_AN8804_PHY_LED_TYPE_SERIAL   (0)

#define HAL_AN8804_PHY_PHY_PAGE_0000 (0)
#define HAL_AN8804_PHY_PHY_PAGE_2A30 (1)
#define HAL_AN8804_PHY_PHY_PAGE_52B5 (2)
#define HAL_AN8804_PHY_PHY_PAGE_0001 (3)
#define HAL_AN8804_PHY_PHY_PAGE_0002 (4)
#define HAL_AN8804_PHY_PHY_PAGE_0003 (5)
#define HAL_AN8804_PHY_PHY_PAGE_0004 (6)

#define HAL_AN8804_PHY_HW_TRAP_READ_REG    (0x10000094)
#define HAL_AN8804_PHY_PHY_BASE_ADDR_MASK  (0x3)
#define HAL_AN8804_PHY_PHY_BASE_ADDR_SHIFT (20)

/* PSR */
#define HAL_AN8804_PHY_PSR_P3_P0_REG     (0x1021c018)
#define HAL_AN8804_PHY_PSR_P4_REG        (0x1021c01c)
#define HAL_AN8804_PHY_PER_PSR_PORTS     (4)
#define HAL_AN8804_PHY_PER_PSR_OFFSET    (8)
#define HAL_AN8804_PHY_PSR_LINK_STS_MASK (0x00000001)
...
/* FUNCTION NAME: hal_an8804_phy_getDriver
 * PURPOSE:
