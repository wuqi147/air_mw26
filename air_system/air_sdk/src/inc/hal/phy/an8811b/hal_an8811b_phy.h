...
/* FILE NAME:  hal_an8811b_phy.h
 * PURPOSE:
 *      It provides PHY module API.
 * NOTES:
 */

#ifndef HAL_AN8811B_PHY_H
#define HAL_AN8811B_PHY_H
 ...
 */
#define HAL_PHY_DEVICE_ID_AN8811B (0xc0ff04a0)

#define AN8811B_TX_POLARITY_NORMAL (0x1 << 7)
#define AN8811B_RX_POLARITY_NORMAL (0x1 << 7)
#define AN8811B_LPBK_FAR_END       (0x8000)

#define AN8811B_AUX_CTRL_SPEED_MASK (0x000c)
#define AN8811B_AUX_CTRL_SPEED_2500 (0x000c)
#define AN8811B_AUX_CTRL_SPEED_1000 (0x0008)
#define AN8811B_AUX_CTRL_SPEED_100  (0x0004)
#define AN8811B_AUX_CTRL_SPEED_10   (0x0000)

/* CRC opration */
#define AN8811B_RG_CRC_PM_SET1 (0xf020c)
#define AN8811B_RG_CRC_PM_OUT  (0xf0214)
#define AN8811B_RG_CRC_PM_MON2 (0xf0218)
#define AN8811B_RG_CRC_PM_MON3 (0xf021c)
#define AN8811B_RG_CRC_DM_SET1 (0xf0224)
#define AN8811B_RG_CRC_DM_OUT  (0xf022c)
#define AN8811B_RG_CRC_DM_MON2 (0xf0230)
#define AN8811B_RG_CRC_DM_MON3 (0xf0234)
#define AN8811B_CRC_RD_EN      BIT(0)
#define AN8811B_CRC_ST_MASK    (BIT(0) | BIT(1))
#define AN8811B_CRC_CHECK_PASS BIT(0)

/* LED Behavior */
#define AN8811B_LED_BHV_LINK_1000     (0x0001)
#define AN8811B_LED_BHV_LINK_100      (0x0002)
#define AN8811B_LED_BHV_LINK_10       (0x0004)
#define AN8811B_LED_BHV_LINK_FULLDPLX (0x0008)
#define AN8811B_LED_BHV_LINK_HALFDPLX (0x0010)
#define AN8811B_LED_BHV_BLINK_TX_1000 (0x0020)
#define AN8811B_LED_BHV_BLINK_RX_1000 (0x0040)
#define AN8811B_LED_BHV_BLINK_TX_100  (0x0080)
#define AN8811B_LED_BHV_BLINK_RX_100  (0x0100)
#define AN8811B_LED_BHV_BLINK_TX_10   (0x0200)
#define AN8811B_LED_BHV_BLINK_RX_10   (0x0400)
#define AN8811B_LED_BHV_HIGH_ACTIVE   (0x0800)
#define AN8811B_LED_BHV_LINK_2500     (0x1000)
#define AN8811B_LED_BHV_BLINK_TX_2500 (0x2000)
#define AN8811B_LED_BHV_BLINK_RX_2500 (0x4000)

/* LED Link register */
#define AN8811B_LED_LINK_1000     (0x0001)
#define AN8811B_LED_LINK_100      (0x0002)
#define AN8811B_LED_LINK_10       (0x0004)
#define AN8811B_LED_LINK_DOWN     (0x0008)
#define AN8811B_LED_LINK_FULLDPLX (0x0010)
#define AN8811B_LED_LINK_HALFDPLX (0x0020)
#define AN8811B_LED_LINK_FORCE_ON (0x0040)
#define AN8811B_LED_LINK_2500     (0x0100)
#define AN8811B_LED_POL_HIGH_ACT  (0x4000)
#define AN8811B_LED_FUNC_ENABLE   (0xC000)

/* LED Blink register */
#define AN8811B_LED_BLINK_TX_1000 (0x0001)
#define AN8811B_LED_BLINK_RX_1000 (0x0002)
#define AN8811B_LED_BLINK_TX_100  (0x0004)
#define AN8811B_LED_BLINK_RX_100  (0x0008)
#define AN8811B_LED_BLINK_TX_10   (0x0010)
#define AN8811B_LED_BLINK_RX_10   (0x0020)
#define AN8811B_LED_BLINK_FORCE   (0x0200)
#define AN8811B_LED_BLINK_TX_2500 (0x0400)
#define AN8811B_LED_BLINK_RX_2500 (0x0800)

/* LED Register */
#define AN8811B_LED_COUNT          (2)
#define AN8811B_LED_ON_DURATION    (0x0022)
#define AN8811B_LED_BLINK_DURATION (0x0023)
#define AN8811B_LED_0_ON_MASK      (0x0024)
#define AN8811B_LED_0_BLK_MASK     (0x0025)
#define AN8811B_LED_1_ON_MASK      (0x0026)
#define AN8811B_LED_1_BLK_MASK     (0x0027)
#define AN8811B_LED_2_ON_MASK      (0x0028)
#define AN8811B_LED_2_BLK_MASK     (0x0029)
#define AN8811B_LED_3_ON_MASK      (0x002A)
#define AN8811B_LED_3_BLK_MASK     (0x002B)

#define AN8811B_LED_RG_OFFSET           (0x0002)
#define AN8811B_LED_CFG_RG_OFFSET       (0x0003)
#define AN8811B_LED_0_CFG_CTRL_MODE_BIT (0x0000)
#define AN8811B_LED_CFG_CTRL_MODE_WIDTH (0x0001)
#define AN8811B_LED_CFG_CTRL_MODE_MASK  (0x0001)
#define AN8811B_LED_CFG_STATE_MASK      (0x0003)
#define AN8811B_LED_0_CFG_STATE_BIT     (0x0001)
#define AN8811B_LED_CFG_STATE_WIDTH     (0x0002)
#define AN8811B_LED_CFG_PATT_BIT        (0x0009)
#define AN8811B_LED_CFG_PATT_WIDTH      (0x0002)
#define AN8811B_LED_CFG_PATT_MASK       (0x0003)

#define AN8811B_LED_BLINK_RATE_DEFAULT (0x1400)
#define AN8811B_LED_BLINK_RATE_HZ_HALF (0xEF00)
#define AN8811B_LED_BLINK_RATE_HZ_ONE  (0x7780)
#define AN8811B_LED_BLINK_RATE_HZ_TWO  (0x38C0)
...
#define AN8811B_PHY_MII_PAGE_SELECT  (0x1F)
#define AN8811B_PHY_CL22_PAGE_REG    (0x0)
#define AN8811B_PHY_CL22_PAGE_EXTREG (0x1)

/* CL45 dev1Eh rg_host_ctrl */
#define AN8811B_RG_HOST_STATUS (0x8009)
#define AN8811B_RG_HOST_ACK    (0x800A)
#define AN8811B_RG_HOST_DES_H  (0x800E)
#define AN8811B_RG_HOST_DES_L  (0x800F)

/* Host command */
#define AN8811B_HOST_CMD_MAX_RETRY     (20)
#define AN8811B_HOST_CMD_ISSUE         (0x1100)
#define AN8811B_CMD_EEE_1G_100M_ENABLE (0xE7)
#define AN8811B_CMD_EEE_2G5_ENABLE     (0xEE)
#define AN8811B_CMD_EEE_DISABLE        (0xE8)

/* Host command status */
#define AN8811B_HOST_STATUS_READY   (0x02)
#define AN8811B_HOST_STATUS_INVOKED (0x4000)
#define AN8811B_HOST_STATUS_NO_ACK  (0x8000)

/* 0x52b5100 */
#define AN8811B_RgAddr_TrReg10h (0x10)
/* 0x52b5110 */
#define AN8811B_RgAddr_TrReg11h (0x11)
/* 0x52b5120 */
#define AN8811B_RgAddr_TrReg12h (0x12)
#define AN8811B_CL22_Page_TrReg (0x52B5)
...
/* FUNCTION NAME: hal_an8811b_phy_getDriver
 * PURPOSE:
 *      AN8811B PHY probe get driver
 *
 * INPUT:
...
#endif /* #ifndef HAL_AN8811B_PHY_H */
