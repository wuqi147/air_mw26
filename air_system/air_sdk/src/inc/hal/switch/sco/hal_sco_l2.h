 ...
 */
#define HAL_SCO_L2_MAX_BUSY_TIME (200)
#define HAL_SCO_L2_MAX_AGE_CNT   (BITS(0, (AAC_AGE_CNT_LENGTH - 1)))
#define HAL_SCO_L2_MAX_AGE_UNIT  (BITS(0, (AAC_AGE_UNIT_LENGTH - 1)))
#define HAL_SCO_L2_MAC_SET_NUM   (4)
#define HAL_SCO_L2_MAX_ADDR_NUM  (2048)
#define HAL_SCO_L2_MAX_ENTRY_NUM (HAL_SCO_L2_MAC_SET_NUM * HAL_SCO_L2_MAX_ADDR_NUM)

#ifdef AIR_EN_L2_SHADOW
#define HAL_SCO_L2_POLL_THREAD_PRI   (3)
#define HAL_SCO_L2_POLL_THREAD_STACK (4 * 1024)
#define HAL_SCO_L2_POLL_MAX_NUM      (HAL_SCO_L2_MAC_SET_NUM * 16)

#define HAL_SCO_L2_NOTIFY_HANDLER_CNT (4)

typedef enum
{
    HAL_SCO_L2_POLL_INTERVAL_1000MS,
    HAL_SCO_L2_POLL_INTERVAL_500MS,
    HAL_SCO_L2_POLL_INTERVAL_250MS,
    HAL_SCO_L2_POLL_INTERVAL_125MS,
    HAL_SCO_L2_POLL_INTERVAL_LAST
} HAL_SCO_L2_POLL_INTERVAL_T;
#endif /* End of AIR_EN_L2_SHADOW */

typedef enum
{
    HAL_SCO_L2_FDB_FULL_NONE = 0,
    HAL_SCO_L2_FDB_FULL_HW_REPLACE_OLDEST_DYNAMIC_ENTRY,
    HAL_SCO_L2_FDB_FULL_LAST
} HAL_SCO_L2_FDB_FULL_T;

/* MACRO FUNCTION DECLARATIONS
 */
#define HAL_SCO_L2_IS_UC_ADDR(__ptr_mac__) ((1 == (((__ptr_mac__)[0]) & 0x1)) ? 0 : 1)

#ifdef AIR_EN_L2_SHADOW
#define HAL_SCO_L2_FDB_LOCK(__unit__)   hal_sco_l2_lockL2FdbResource(__unit__)
#define HAL_SCO_L2_FDB_UNLOCK(__unit__) hal_sco_l2_unlockL2FdbResource(__unit__)
#define HAL_SCO_L2_SW_LOCK(__unit__)    HAL_COMMON_LOCK_RESOURCE( \
    PTR_HAL_SCO_L2_SW_TBL_MUTEX(__unit__),                        \
    AIR_SEMAPHORE_WAIT_FOREVER);
#define HAL_SCO_L2_SW_UNLOCK(__unit__) HAL_COMMON_FREE_RESOURCE( \
    PTR_HAL_SCO_L2_SW_TBL_MUTEX(__unit__));
#define HAL_SCO_L2_NOTIFY_LOCK(__unit__) HAL_COMMON_LOCK_RESOURCE( \
    PTR_HAL_SCO_L2_NOTIFY_MUTEX(__unit__),                         \
    AIR_SEMAPHORE_WAIT_FOREVER);
#define HAL_SCO_L2_NOTIFY_UNLOCK(__unit__) HAL_COMMON_FREE_RESOURCE( \
    PTR_HAL_SCO_L2_NOTIFY_MUTEX(__unit__));
#else /* Else of AIR_EN_L2_SHADOW */
#define HAL_SCO_L2_FDB_LOCK(__unit__)
#define HAL_SCO_L2_FDB_UNLOCK(__unit__)
#define HAL_SCO_L2_SW_LOCK(__unit__)
#define HAL_SCO_L2_SW_UNLOCK(__unit__)
#define HAL_SCO_L2_NOTIFY_LOCK(__unit__)
#define HAL_SCO_L2_NOTIFY_UNLOCK(__unit__)
#endif /* End of AIR_EN_L2_SHADOW */

/* DATA TYPE DECLARATIONS
 */
#ifdef AIR_EN_L2_SHADOW
typedef struct HAL_SCO_L2_NOTIFY_HANDLER_S
{
    AIR_L2_MAC_NOTIFY_FUNC_T notify_func;
    void                    *ptr_cookie;
} HAL_SCO_L2_NOTIFY_HANDLER_T;

typedef struct HAL_SCO_L2_FDB_SW_ENTRY_S
{
    AIR_MAC_ENTRY_T   entry;
    UI32_T            entry_id;     /* HW address + bank */
    BOOL_T            is_valid;     /* Entry valid bit */
    CMLIB_RBT_NODE_T *ptr_rbt_node; /* RBT node */
} HAL_SCO_L2_FDB_SW_ENTRY_T;

typedef struct HAL_SCO_L2_POLLING_CB_S
{
    AIR_THREAD_ID_T task_id;
    BOOL_T          state;
    UI32_T          interval;     /* interval timer per max_poll_num entries */
    UI32_T          max_poll_num; /* default 1K entry */
    UI32_T          cur_poll_num;
} HAL_SCO_L2_POLLING_CB_T;
#endif /* End of AIR_EN_L2_SHADOW */

typedef struct HAL_SCO_L2_FDB_CB_S
{
#ifdef AIR_EN_L2_SHADOW
    HAL_SCO_L2_FDB_SW_ENTRY_T *ptr_sw_entry;
    CMLIB_RBT_HEAD_T          *ptr_rbt_head; /* RBT head */
    HAL_SCO_L2_POLLING_CB_T    polling_cb;
#endif                                       /* End of AIR_EN_L2_SHADOW */
    AIR_SEMAPHORE_ID_T hw_tbl_mutex;
#ifdef AIR_EN_L2_SHADOW
    AIR_SEMAPHORE_ID_T          sw_tbl_mutex;
    AIR_SEMAPHORE_ID_T          notify_mutex;
    HAL_SCO_L2_NOTIFY_HANDLER_T notify_handler[HAL_SCO_L2_NOTIFY_HANDLER_CNT];
#endif /* End of AIR_EN_L2_SHADOW */
} HAL_SCO_L2_FDB_CB_T;
