...
#ifndef HAL_SCO_SEC_H
#define HAL_SCO_SEC_H
 ...
 */
#define HAL_SCO_SEC_MAX_BUSY_TIME (20)
#define HAL_SCO_SEC_MAX_AGE_CNT   (BITS(0, (AAC_AGE_CNT_LENGTH - 1)))
#define HAL_SCO_SEC_MAX_AGE_UNIT  (BITS(0, (AAC_AGE_UNIT_LENGTH - 1)))
#define HAL_SCO_SEC_MAC_SET_NUM   (4)
#define HAL_SCO_SEC_MAX_SIZE      (2048)

#define HAL_SCO_SEC_STORMCTL_MAX_COUNT (255)

#define HAL_SCO_SEC_STORMCTL_PPS_TOKEN_SIZE_UNIT_64  (64)
#define HAL_SCO_SEC_STORMCTL_PPS_TOKEN_SIZE_UNIT_256 (256)
#define HAL_SCO_SEC_STORMCTL_PPS_TOKEN_SIZE_UNIT_1K  (1024)
#define HAL_SCO_SEC_STORMCTL_PPS_TOKEN_SIZE_UNIT_4K  (4096)
#define HAL_SCO_SEC_STORMCTL_PPS_TOKEN_SIZE_UNIT_16K (16384)

#define HAL_SCO_SEC_STORMCTL_BPS_TOKEN_SIZE_UNIT_64  (3 * 64)
#define HAL_SCO_SEC_STORMCTL_BPS_TOKEN_SIZE_UNIT_256 (3 * 256)
#define HAL_SCO_SEC_STORMCTL_BPS_TOKEN_SIZE_UNIT_1K  (3 * 1024)
#define HAL_SCO_SEC_STORMCTL_BPS_TOKEN_SIZE_UNIT_4K  (3 * 4096)
#define HAL_SCO_SEC_STORMCTL_BPS_TOKEN_SIZE_UNIT_16K (3 * 16384)

#define HAL_SCO_SEC_STORMCTL_MAX_TOKEN_SIZE (0x3fffff)

#define HAL_SEC_STORM_RATE_MAX_VALUE (2500000)

#define HAL_SCO_SEC_STORMCTL_DEFAULT_TOKEN_VAL      (0x4000)
#define HAL_SCO_SEC_STORMCTL_DEFAULT_2P5G_TOKEN_VAL (0xa000)
/* During a fixed 15k-length traffic test, the max. token bucket size must
 * reach the following values to satisfy the max. speed limit for various
 * connection speeds. */
#define HAL_SCO_SEC_STORMCTL_10M_TOKEN_VAL   (0x6000)
#define HAL_SCO_SEC_STORMCTL_100M_TOKEN_VAL  (0x8000)
#define HAL_SCO_SEC_STORMCTL_1000M_TOKEN_VAL (0xC000)
#define HAL_SCO_SEC_STORMCTL_2500M_TOKEN_VAL (0x12000)

#define HAL_SCO_SEC_STORMCTL_TOKEN_125US     (8000)
#define HAL_SCO_SEC_STORMCTL_RATE_CNT_LENGTH (8)
 ...
 */
typedef union HAL_SCO_SEC_STORMCTL_STAT_S
{
    struct
    {
        ...
        UI32_T csr_strm_rsv0   : 2;
        UI32_T csr_strm_unit   : 3;
        UI32_T csr_strm_rsv1   : 21;
    } raw;
    UI32_T byte;
} HAL_SCO_SEC_STORMCTL_STAT_T;

typedef union HAL_SCO_SEC_STORMCTL_LINKSPEED_S
{
    struct
    {
    ...
    UI32_T byte;
} HAL_SCO_SEC_STORMCTL_LINKSPEED_T;

typedef struct HAL_SCO_SEC_STORMCTL_TOKENSIZE_S
{
    UI32_T csr_strm_bkt_sz_10;
    UI32_T csr_strm_bkt_sz_100;
    UI32_T csr_strm_bkt_sz_1000;
    UI32_T csr_strm_bkt_sz_2500;
} HAL_SCO_SEC_STORMCTL_TOKENSIZE_T;

typedef enum HAL_SCO_SEC_STORMCTL_PERIOD_S
{
    HAL_SCO_SEC_STORMCTL_PERIOD_1S = 0,
    HAL_SCO_SEC_STORMCTL_PERIOD_125US = 1,
    HAL_SCO_SEC_STORMCTL_PERIOD_LAST
} HAL_SCO_SEC_STORMCTL_PERIOD_T;

typedef enum HAL_SCO_SEC_STORMCTL_UNIT_S
{
    HAL_SCO_SEC_STORMCTL_UNIT_64,
    HAL_SCO_SEC_STORMCTL_UNIT_256,
    HAL_SCO_SEC_STORMCTL_UNIT_1000,
    HAL_SCO_SEC_STORMCTL_UNIT_4000,
    HAL_SCO_SEC_STORMCTL_UNIT_16000,
    HAL_SCO_SEC_STORMCTL_UNIT_LAST
} HAL_SCO_SEC_STORMCTL_UNIT_T;
