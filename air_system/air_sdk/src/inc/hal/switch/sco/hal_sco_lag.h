...
#ifndef HAL_SCO_LAG_H
#define HAL_SCO_LAG_H
 ...
 */
#define HAL_SCO_LAG_VALID_MIN           (0) /* Minimum LAG ID */
#define HAL_SCO_LAG_VALID_MAX           (7) /* Maximum LAG ID */
#define HAL_SCO_LAG_MAX_GROUP_NUM       (8) /* LAG group port range 0 - 7 */
#define HAL_SCO_LAG_MAX_MEMBER_PORT_NUM (8) /* LAG member port range 0 - 7 */

/* MACRO FUNCTION DECLARATIONS
 */
#define HAL_SCO_LAG_IS_LAG_ID_VALID(lag_id)                                      \
    (((lag_id) >= HAL_SCO_LAG_VALID_MIN) && ((lag_id) <= HAL_SCO_LAG_VALID_MAX))

/* DATA TYPE DECLARATIONS
 */
typedef enum
{
    HAL_SCO_LAG_HASH_TABLE_1 = 0,
    HAL_SCO_LAG_HASH_TABLE_2,
    HAL_SCO_LAG_HASH_TABLE_LAST
} HAL_SCO_LAG_HASH_TABLE_ID_T;
...
/* FUNCTION NAME:   hal_sco_lag_destroyGroup
 * PURPOSE:
