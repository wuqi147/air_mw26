...
#ifndef HAL_CORAL_LAG_H
#define HAL_CORAL_LAG_H
 ...
 */
#define HAL_CORAL_LAG_MAX_GROUP_NUM       (2) /* LAG group port range 0 - 1 */
#define HAL_CORAL_LAG_MAX_MEMBER_PORT_NUM (4) /* LAG member port range 0 - 3 */
#define HAL_CORAL_LAG_VALID_MIN           (0) /* Minimum LAG ID */
#define HAL_CORAL_LAG_VALID_MAX           (1) /* Maximum LAG ID */
...
/* FUNCTION NAME:   hal_coral_lag_destroyGroup
 * PURPOSE:
