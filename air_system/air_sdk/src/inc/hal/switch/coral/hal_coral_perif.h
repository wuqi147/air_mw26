...
/* FILE NAME:  hal_coral_perif.h
 * PURPOSE:
 *    It provides peripheral module API.
 * NOTES:
 */

#ifndef HAL_CORAL_PERIF_H
#define HAL_CORAL_PERIF_H
 ...
 */
#define HAL_CORAL_PERIF_GPIO_PIN_COUNT       (21)
#define HAL_CORAL_PERIF_GPIO_PIN_BOUNDARY    (16)
#define HAL_CORAL_PERIF_GPIO_PIN_FLASH_COUNT (16)
#define HAL_CORAL_PERIF_BIT_MASK             (1)
#define HAL_CORAL_PERIF_TWO_BIT_MASK         (3)
...
#endif /* end of HAL_CORAL_PERIF_H */
