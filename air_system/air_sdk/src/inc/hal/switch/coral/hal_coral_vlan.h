...
#ifndef HAL_CORAL_VLAN_H
#define HAL_CORAL_VLAN_H
 ...
 */
#define HAL_CORAL_VLAN_FILTER_ID_MAX (15)
...
*/
#define HAL_CORAL_VLAN_QINQ_MAC_IPV4_MAX_ENTRY_CNT  (64)
#define HAL_CORAL_VLAN_DEFAULT_ENTRY_CNT_QINQ       (16)
#define HAL_CORAL_VLAN_DEFAULT_ENTRY_CNT_MAC_BASED  (16)
#define HAL_CORAL_VLAN_DEFAULT_ENTRY_CNT_IPV4_BASED (32)
#define HAL_CORAL_VLAN_IPV6_BASED_MAX_ENTRY_CNT     (16)
#define HAL_CORAL_VLAN_PROTOCOL_BASED_MAX_ENTRY_CNT (4)

#define HAL_CORAL_VLAN_MASK_LENGTH_MAC_BASED         (48)
#define HAL_CORAL_VLAN_MASK_LENGTH_SUBNET_BASED_IPV6 (128)

#define HAL_CORAL_VLAN_PPBV_VID_OFFSET (0)
#define HAL_CORAL_VLAN_PPBV_VID_MASK   (0xfff)
#define HAL_CORAL_VLAN_PPBV_PRI_OFFSET (13)
#define HAL_CORAL_VLAN_PPBV_PRI_MASK   (0x7)

#define HAL_CORAL_VLAN_VTCR_BUSY_WAIT_MAX_CNT (100000)
/* MACRO FUNCTION DECLARATIONS
 */
#define PTR_HAL_CORAL_VLAN_VTCR_MUTEX(__unit__) \
...
typedef enum
{
    HAL_CORAL_VLAN_VTCR_ACCESS_CTRL_TYPE_VLAN_READ = 0,
    HAL_CORAL_VLAN_VTCR_ACCESS_CTRL_TYPE_VLAN_WRITE,
    HAL_CORAL_VLAN_VTCR_ACCESS_CTRL_TYPE_VLAN_INVALID,
    HAL_CORAL_VLAN_VTCR_ACCESS_CTRL_TYPE_VLAN_VALID,
    HAL_CORAL_VLAN_VTCR_ACCESS_CTRL_TYPE_MAC_IPV4_QINQ_READ,
    HAL_CORAL_VLAN_VTCR_ACCESS_CTRL_TYPE_MAC_IPV4_QINQ_WRITE,
    HAL_CORAL_VLAN_VTCR_ACCESS_CTRL_TYPE_MAC_IPV4_QINQ_INVALID,
    HAL_CORAL_VLAN_VTCR_ACCESS_CTRL_TYPE_MAC_IPV4_QINQ_VALID,
    HAL_CORAL_VLAN_VTCR_ACCESS_CTRL_TYPE_IPV6_READ,
    HAL_CORAL_VLAN_VTCR_ACCESS_CTRL_TYPE_IPV6_WRITE,
    HAL_CORAL_VLAN_VTCR_ACCESS_CTRL_TYPE_IPV6_INVALID,
    HAL_CORAL_VLAN_VTCR_ACCESS_CTRL_TYPE_IPV6_VALID,
    HAL_CORAL_VLAN_VTCR_ACCESS_CTRL_TYPE_PROTOCOL_READ,
    HAL_CORAL_VLAN_VTCR_ACCESS_CTRL_TYPE_PROTOCOL_WRITE,
    HAL_CORAL_VLAN_VTCR_ACCESS_CTRL_TYPE_PROTOCOL_INVALID,
    HAL_CORAL_VLAN_VTCR_ACCESS_CTRL_TYPE_PROTOCOL_VALID,
    HAL_CORAL_VLAN_VTCR_ACCESS_CTRL_TYPE_LAST
} HAL_CORAL_VLAN_VTCR_ACCESS_CTRL_TYPE_T;

typedef struct HAL_CORAL_VLAN_CB_S
{
    AIR_SEMAPHORE_ID_T vtcr_mutex;
} HAL_CORAL_VLAN_CB_T;

typedef struct HAL_CORAL_VLAN_ENTRY_S
{
    BOOL_T            valid;
    UI8_T             fid;
    BOOL_T            ivl;
    ...
    UI16_T            stag;
} HAL_CORAL_VLAN_ENTRY_T;

typedef enum
{
    /* Port matrix mode  */
    HAL_CORAL_VLAN_PORT_MODE_PORT_MATRIX = 0,

    /* Fallback mode  */
    HAL_CORAL_VLAN_PORT_MODE_FALLBACK,

    /* Check mode  */
    HAL_CORAL_VLAN_PORT_MODE_CHECK,

    /* Security mode  */
    HAL_CORAL_VLAN_PORT_MODE_SECURITY,
    HAL_CORAL_VLAN_PORT_MODE_LAST
} HAL_CORAL_VLAN_PORT_MODE_T;
