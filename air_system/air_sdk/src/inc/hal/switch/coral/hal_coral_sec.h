...
#ifndef HAL_CORAL_SEC_H
#define HAL_CORAL_SEC_H
 ...
 */
#define HAL_CORAL_SEC_MAX_BUSY_TIME (20)
#define HAL_CORAL_SEC_MAX_AGE_CNT   (BITS(0, (AAC_AGE_CNT_LENGTH - 1)))
#define HAL_CORAL_SEC_MAX_AGE_UNIT  (BITS(0, (AAC_AGE_UNIT_LENGTH - 1)))
#define HAL_CORAL_SEC_MAC_SET_NUM   (4)
#define HAL_CORAL_SEC_MAX_SIZE      (2048)

#define HAL_CORAL_SEC_STORMCTL_MAX_COUNT (255)

#define HAL_CORAL_SEC_STORMCTL_MAX_TOKEN_SIZE (0xffffff)

/* define the max rate for kbps mode on 10Gbps */
#define HAL_CORAL_SEC_STORMCTL_MAX_RATE_KBPS (10000000)
/* define the max rate for PPS mode with 64 bytes packet on 10Gbps */
#define HAL_CORAL_SEC_STORMCTL_MAX_RATE_PPS (14880953)

#define HAL_CORAL_SEC_STORMCTL_KBPS_BASE (64)
#define HAL_CORAL_SEC_STORMCTL_PPS_BASE  (8000)

#define HAL_CORAL_SEC_STORMCTL_DEFAULT_TOKEN_VAL      (0x4000)
#define HAL_CORAL_SEC_STORMCTL_DEFAULT_2P5G_TOKEN_VAL (0xa000)
#define HAL_CORAL_SEC_STORMCTL_TOKEN_125US            (8000)
#define HAL_CORAL_SEC_STORMCTL_PPS_AVG_TOKEN_LENGTH   (8)
#define HAL_CORAL_SEC_STORMCTL_BPS_TOKEN_LENGTH       (16)

#define HAL_CORAL_SEC_STORM_MAX_UNIT_KBPS        (2)
#define HAL_CORAL_SEC_STORM_MAX_UNIT_PPS_BURST   (8)
#define HAL_CORAL_SEC_STORM_MAX_UNIT_PPS_AVERAGE (3)
 ...
 */
typedef union HAL_CORAL_SEC_STORMCTL_BSR_S
{
    struct
    {
        ...
        UI32_T csr_pps_mode        : 1;
        UI32_T csr_strm_unit       : 4;
        UI32_T csr_strm_rsv1       : 21;
    } raw;
    UI32_T byte;
} HAL_CORAL_SEC_STORMCTL_BSR_T;

typedef union HAL_CORAL_SEC_STORMCTL_BSR1_S
{
    struct
    {
        UI32_T token : 16;
    ...
    UI32_T byte;
} HAL_CORAL_SEC_STORMCTL_BSR1_T;

typedef struct HAL_CORAL_SEC_STORMCTL_TOKENSIZE_S
{
    UI32_T csr_strm_bkt_sz_10;
    UI32_T csr_strm_bkt_sz_100;
    UI32_T csr_strm_bkt_sz_1000;
    UI32_T csr_strm_bkt_sz_2500;
} HAL_CORAL_SEC_STORMCTL_TOKENSIZE_T;

typedef enum HAL_CORAL_SEC_STORMCTL_UNIT_S
{
    HAL_CORAL_SEC_STORMCTL_UNIT_64,
    HAL_CORAL_SEC_STORMCTL_UNIT_256,
    HAL_CORAL_SEC_STORMCTL_UNIT_1000,
    HAL_CORAL_SEC_STORMCTL_UNIT_4000,
    HAL_CORAL_SEC_STORMCTL_UNIT_16000,
    HAL_CORAL_SEC_STORMCTL_UNIT_LAST
} HAL_CORAL_SEC_STORMCTL_UNIT_T;
...
/* FUNCTION NAME:   hal_coral_sec_setPortStormCtrlRate
 * PURPOSE:
...
/* FUNCTION NAME:   hal_coral_sec_getPortStormCtrlRate
 * PURPOSE:
