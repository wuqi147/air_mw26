...
#ifndef HAL_CORAL_SFLOW_H
#define HAL_CORAL_SFLOW_H
 ...
 */
#define HAL_CORAL_SFLOW_MIN_SAMPLING_RATE (0)
#define HAL_CORAL_SFLOW_MAX_SAMPLING_RATE (BITS(0, (CORAL_SFLOW_SAMPLING_RATE_LENG - 1))) /* 0xffffff */
#define HAL_CORAL_SFLOW_MIN_SAMPLING_NUM  (1)
#define HAL_CORAL_SFLOW_MAX_SAMPLING_NUM  (0xff)
...
#endif /* end of HAL_CORAL_SFLOW_H */
