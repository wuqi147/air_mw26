...
#ifndef HAL_PEARL_DOS_H
#define HAL_PEARL_DOS_H
 ...
 */
#define HAL_PEARL_DOS_MAX_BUSY_TIME     (20)
#define HAL_PEARL_DOS_DELAY_US          (1000)
#define HAL_PEARL_DOS_MIN_ATTACK_LENGTH (0)
#define HAL_PEARL_DOS_MAX_ATTACK_LENGTH (BITS(0, (PEARL_ATTACK_LENGTH_THLD_LENG - 1))) /* 0xffff */
#define HAL_PEARL_DOS_MIN_RATE_ID       (0)
#define HAL_PEARL_DOS_MAX_RATE_ID       (95)
#define HAL_PEARL_DOS_MIN_RATE_WR_CFG   (0)
#define HAL_PEARL_DOS_MAX_RATE_WR_CFG   (BITS(0, (PEARL_ATTACK_RATE_WR_CFG_LENG - 1))) /* 0xffff */
