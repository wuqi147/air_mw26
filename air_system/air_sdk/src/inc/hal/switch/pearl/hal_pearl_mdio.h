...
#ifndef HAL_PEARL_MDIO_H
#define HAL_PEARL_MDIO_H
...
#define CLK_MDIO_CFG      (0x10005048)
#define CSR_CLK_MDIO_MASK (0x0000007F)
#define CSR_CLK_MDIO_OFFT (0)
...
#define SET_MDIO_PHY(__phy__)   ((__phy__ & CSR_MDIO_PHY_ADDR_RELMASK) << CSR_MDIO_PHY_ADDR_OFFT)
#define SET_MDIO_REG(__reg__)   ((__reg__ & CSR_MDIO_REG_ADDR_RELMASK) << CSR_MDIO_REG_ADDR_OFFT)
#define SET_MDIO_DATA(__data__) ((__data__ & CSR_MDIO_WR_DATA_RELMASK) << CSR_MDIO_WR_DATA_OFFT)
#define GET_MDIO_DATA(__data__) ((__data__ & CSR_MDIO_RD_DATA_RELMASK) << CSR_MDIO_RD_DATA_OFFT)
