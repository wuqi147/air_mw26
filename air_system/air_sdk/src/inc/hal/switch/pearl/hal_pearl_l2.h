...
#ifndef HAL_PEARL_L2_H
#define HAL_PEARL_L2_H
 ...
 */
#define HAL_PEARL_L2_MAX_BUSY_TIME (200)
#define HAL_PEARL_L2_MAX_AGE_CNT   (BITS(0, (AAC_AGE_CNT_LENGTH - 1)))
#define HAL_PEARL_L2_MAX_AGE_UNIT  (BITS(0, (AAC_AGE_UNIT_LENGTH - 1)))
#define HAL_PEARL_L2_MAC_SET_NUM   (4)
#define HAL_PEARL_L2_MAX_ADDR_NUM  (512)
#define HAL_PEARL_L2_MAX_ENTRY_NUM (HAL_PEARL_L2_MAC_SET_NUM * HAL_PEARL_L2_MAX_ADDR_NUM)

typedef enum
{
    HAL_PEARL_L2_FDB_FULL_NONE = 0,
    HAL_PEARL_L2_FDB_FULL_HW_REPLACE_OLDEST_DYNAMIC_ENTRY,
    HAL_PEARL_L2_FDB_FULL_LAST
} HAL_PEARL_L2_FDB_FULL_T;

/* MACRO FUNCTION DECLARATIONS
 */
#define HAL_PEARL_L2_IS_UC_ADDR(__ptr_mac__) ((1 == (((__ptr_mac__)[0]) & 0x1)) ? 0 : 1)
#define HAL_PEARL_L2_FDB_LOCK(__unit__)      hal_pearl_l2_lockL2FdbResource(__unit__)
#define HAL_PEARL_L2_FDB_UNLOCK(__unit__)    hal_pearl_l2_unlockL2FdbResource(__unit__)

/* DATA TYPE DECLARATIONS
 */
typedef struct HAL_PEARL_L2_FDB_CB_S
{
    AIR_SEMAPHORE_ID_T hw_tbl_mutex;
} HAL_PEARL_L2_FDB_CB_T;
