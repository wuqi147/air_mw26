...
#ifndef HAL_PEARL_SWC_H
#define HAL_PEARL_SWC_H
 ...
 */
#define HAL_PEARL_FWD_MODE_SYS_SETTING             (0)
#define HAL_PEARL_FWD_MODE_SYS_SETTING_EXCLUDE_CPU (4)
#define HAL_PEARL_FWD_MODE_SYS_SETTING_INCLUDE_CPU (5)
#define HAL_PEARL_FWD_MODE_CPU_ONLY                (6)
#define HAL_PEARL_FWD_MODE_DROP                    (7)
