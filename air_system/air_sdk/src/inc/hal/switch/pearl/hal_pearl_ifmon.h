...
/* FILE NAME:  hal_pearl_ifmon.h
 * PURPOSE:
 *      It provide HAL ifmon module API.
 * NOTES:
 */

#ifndef HAL_PEARL_IFMON_H
#define HAL_PEARL_IFMON_H
 ...
 */
#define HAL_PEARL_IFMON_MODE_DFLT     (AIR_IFMON_MODE_POLL)
#define HAL_PEARL_IFMON_INTERVAL_DFLT (500)

#define HAL_PEARL_IFMON_STACK_SIZE (4 * 1024)
#define HAL_PEARL_IFMON_THREAD_PRI (0)

#define HAL_PEARL_IFMON_NOTIFY_HANDLER_CNT (8)

/* MACRO FUNCTION DECLARATIONS
 */
#define HAL_PEARL_IFMON_CFG_LOCK(unit)   hal_pearl_ifmon_lockIfmonResource(unit)
#define HAL_PEARL_IFMON_CFG_UNLOCK(unit) hal_pearl_ifmon_unlockIfmonResource(unit)

#define HAL_PEARL_IFMON_PORT_LOCK(unit)   hal_pearl_ifmon_lockIfmonPortResource(unit)
#define HAL_PEARL_IFMON_PORT_UNLOCK(unit) hal_pearl_ifmon_unlockIfmonPortResource(unit)
/* DATA TYPE DECLARATIONS
 */
typedef struct HAL_PEARL_IFMON_STAT_S
{
    AIR_PORT_BITMAP_T link_bitmap;
} HAL_PEARL_IFMON_STATE_T;

typedef struct HAL_PEARL_IFMON_NOTIFY_HANDLER_S
{
    AIR_IFMON_NOTIFY_FUNC_T notify_func;
    void                   *ptr_cookie;
} HAL_PEARL_IFMON_NOTIFY_HANDLER_T;

typedef struct HAL_PEARL_IFMON_CB_S
{
    ...
    HAL_PEARL_IFMON_STATE_T          dev_state;
    HAL_PEARL_IFMON_STATE_T          cur_state;
    HAL_PEARL_IFMON_STATE_T          new_state;
    AIR_PORT_STATUS_T                dev_status[AIR_PORT_NUM];
    HAL_PEARL_IFMON_NOTIFY_HANDLER_T notify_handler[HAL_PEARL_IFMON_NOTIFY_HANDLER_CNT];
} HAL_PEARL_IFMON_CB_T;
...
#endif /* #ifndef HAL_PEARL_IFMON_H */
