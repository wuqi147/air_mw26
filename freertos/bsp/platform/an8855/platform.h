...
#define DMEM_SIZE           (S_64K)

#define DMEM_PDMA_SIZE      (2 * S_4K)
#define DMEM_PMDA_BASE      (DMEM_BASE + DMEM_SIZE - DMEM_PDMA_SIZE)
/* Init stack size for booting. It should be synced with size of PDMA. */
#define DMEM_INITSTACK_SIZE DMEM_PDMA_SIZE
#define DMEM_MIN_HEAP       (S_4K)
...
#define IRQ_PHY3            21
#define IRQ_PHY4            22
#define IRQ_EFIFO0          23
#define IRQ_EFIFO1          24
#define IRQ_EFIFO2          25
#define IRQ_EFIFO3          26
...
#define SPI_DELAY_CELL      SPI_DCL_SEL_0
...
#define SPI_READ_CMD        SPI_FAST_READ
