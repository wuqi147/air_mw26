...
/* LED */
#define IOMUX_CONTROL1_REGISTER       ((unsigned int)(REG_CHIP_SCU_BASE_ADDRESS + 0x0054))

#define IOMUX_BIT_LENG                (1)

/* MISC */
#define IOMUX_CONTROL2_REGISTER       ((unsigned int)(REG_CHIP_SCU_BASE_ADDRESS + 0x008C))

/* ForceGPIO */
#define IOMUX_CONTROL3_REGISTER       ((unsigned int)(REG_CHIP_SCU_BASE_ADDRESS + 0x007C))
