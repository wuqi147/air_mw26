...
#define BUSCLKFREQ              (CPUFREQ>>1)
#define CPUTMRCLK               (50 * MHz)
#else
#define CPUFREQ                 (250 * MHz)
#define BUSCLKFREQ              (250 * MHz)
 ...
 * SYS_CTRL2 Registers
 ****************************************************************************/
#define SYS_CTRL2_CFG                       (CR_NP_SCU_BASE+0x24)
#define SYS_CTRL2_CFG__GDMP_SHARE_EN__POS   (0)
#define SYS_CTRL2_CFG__GDMP_SHARE_EN__ON    (1<<0)
...
#define IRQ_EFIFO           23
#define IRQ_PTP             24
#define IRQ_TOD_GEN         25
#define IRQ_PXP_PHY         26
#define IRQ_EXT_00          27
#define IRQ_EXT_01          28
#define IRQ_EXT_02          29
 ...
 * GSW Top Registers
 ****************************************************************************/
#define CR_GSW_SYS_STATUS   (0x1021800C)
#define CR_GSW_SYS_INT_EN   (0x10218010)
#define CR_GSW_SYS_INT_STS  (0x10218014)
 ...
 ****************************************************************************/
#define SPI_SPEED           SPI_CLOCK_62_5M
#define SPI_CLOCK_62_5M     (0x401)
#define SPI_CLOCK_50M       (0x501)
#define SPI_CLOCK_41_6M     (0x601)

#define SPI_CLOCK_EDGE      SPI_CK_SEL_1
#define SPI_CK_SEL_0        (0x8)
#define SPI_CK_SEL_1        (0x9)
#define SPI_CK_SEL_2        (0xA)

#define SPI_DELAY_CELL      SPI_DCL_SEL_5
#define SPI_DCL_SEL_0       (0x0)
#define SPI_DCL_SEL_1       (0x1)
#define SPI_DCL_SEL_2       (0x2)
#define SPI_DCL_SEL_3       (0x3)
#define SPI_DCL_SEL_4       (0x4)
#define SPI_DCL_SEL_5       (0x5)
#define SPI_DCL_SEL_6       (0x6)
#define SPI_DCL_SEL_7       (0x7)
#define SPI_DCL_SEL_8       (0x8)
#define SPI_DCL_SEL_9       (0x9)
#define SPI_DCL_SEL_10      (0xA)
#define SPI_DCL_SEL_11      (0xB)
#define SPI_DCL_SEL_12      (0xC)
#define SPI_DCL_SEL_13      (0xD)
#define SPI_DCL_SEL_14      (0xE)
#define SPI_DCL_SEL_15      (0xF)
