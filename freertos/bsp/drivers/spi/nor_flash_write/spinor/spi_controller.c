...
#define _SPI_CONTROLLER_REGS_BASE                   0x50003000
...
void __noex9__ SPI_CONTROLLER_Get_Addressing_Mode( u8 *ptr_addressing_mode )
{
    u8 val;
...
SPI_CONTROLLER_RTN_T __noex9__ SPI_CONTROLLER_Set_Configure( SPI_CONTROLLER_CONF_T *ptr_spi_controller_conf_t )
{
 ...
 *------------------------------------------------------------------------------------
 */
SPI_CONTROLLER_RTN_T __noex9__ SPI_CONTROLLER_Enable_Manual_Mode( void )
{
...
SPI_CONTROLLER_RTN_T __noex9__ SPI_CONTROLLER_Enable_Auto_Mode( void )
{
    SPI_CONTROLLER_RTN_T    rtn_status = SPI_CONTROLLER_RTN_NO_ERROR;
    SPI_CONTROLLER_CONF_T   spi_conf_t;
 ...
 *------------------------------------------------------------------------------------
 */
static SPI_CONTROLLER_RTN_T __noex9__ spi_controller_set_opfifo(u8 op_cmd, u32 op_len)
{
    SPI_CONTROLLER_RTN_T    rtn_status = SPI_CONTROLLER_RTN_NO_ERROR;
 ...
 *------------------------------------------------------------------------------------
 */
SPI_CONTROLLER_RTN_T __noex9__ SPI_CONTROLLER_Chip_Select_High(void)
{
    SPI_CONTROLLER_RTN_T    rtn_status = SPI_CONTROLLER_RTN_NO_ERROR;
 ...
 *------------------------------------------------------------------------------------
 */
SPI_CONTROLLER_RTN_T __noex9__ SPI_CONTROLLER_Chip_Select_Low(void)
{
    SPI_CONTROLLER_RTN_T    rtn_status = SPI_CONTROLLER_RTN_NO_ERROR;
 ...
 *------------------------------------------------------------------------------------
 */
static SPI_CONTROLLER_RTN_T __noex9__ spi_controller_write_data_fifo(u8 *ptr_data, u32 data_len)
{
    u32                     idx;
    SPI_CONTROLLER_RTN_T    rtn_status = SPI_CONTROLLER_RTN_NO_ERROR;
 ...
 *------------------------------------------------------------------------------------
 */
static SPI_CONTROLLER_RTN_T __noex9__ spi_controller_read_data_fifo( u8 *ptr_rtn_data, u32 data_len)
{
    u32                     idx;
    SPI_CONTROLLER_RTN_T    rtn_status = SPI_CONTROLLER_RTN_NO_ERROR;
 ...
 *------------------------------------------------------------------------------------
 */
SPI_CONTROLLER_RTN_T __noex9__ SPI_CONTROLLER_Write_One_Byte_With_Cmd(u8 op_cmd,  u8 data )
{
    SPI_CONTROLLER_RTN_T    rtn_status = SPI_CONTROLLER_RTN_NO_ERROR;
...
SPI_CONTROLLER_RTN_T __noex9__ SPI_CONTROLLER_Write_One_Byte( u8 data )
{
 ...
 *------------------------------------------------------------------------------------
 */
SPI_CONTROLLER_RTN_T __noex9__ SPI_CONTROLLER_Write_NByte( u8 *ptr_data, u32 len, SPI_CONTROLLER_SPEED_T speed )
{
    u8                      op_cmd;
 ...
 *------------------------------------------------------------------------------------
 */
SPI_CONTROLLER_RTN_T __noex9__ SPI_CONTROLLER_Read_NByte(u8 *ptr_rtn_data, u32 len, SPI_CONTROLLER_SPEED_T speed)
{
    u8                      op_cmd;
    u32                     data_len, remain_len;
    SPI_CONTROLLER_RTN_T    rtn_status = SPI_CONTROLLER_RTN_NO_ERROR;
