...
# some definition
EXTRA_FLAGS    += -DAIR_8858_SUPPORT -DDUAL_IMAGE=$(DUAL_IMAGE)
...
ifeq ($(SPI_CLK_SPEEDUP), ENABLED)
EXTRA_FLAGS    += -DSPI_CLK_SPEEDUP
endif
...
ifeq ($(IS_FPGA_EN), ENABLED)
CFLAGS += -DIS_FPGA_STAGE
endif
