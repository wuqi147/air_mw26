...
#define MAX_CMD_LEN 64 /* max length of a command */
#define MAX_TERM_LEN 32 /* max length of TERM name */
...
#define MAX_HASH_SIZE 32 /* sha512 */
...
#define DROPBEAR_ECC ((DROPBEAR_ECDH) || (DROPBEAR_ECDSA) || (DROPBEAR_ED25519))
...
#define RECV_MAX_PACKET_LEN (MAX(2048, ((RECV_MAX_PAYLOAD_LEN)+100)))

/* for channel code */
#define RECV_WINDOWEXTEND (opts.recv_window / 3) /* We send a "window extend" every
                                RECV_WINDOWEXTEND bytes */
#define MAX_RECV_WINDOW (1024) /* 10 MB should be enough */

#define MAX_CHANNELS 1 /* simple mem restriction, includes each tcp/x11
...
#define DROPBEAR_MAX_CLI_INTERACT_PROMPTS 10 /* The number of prompts we'll 
