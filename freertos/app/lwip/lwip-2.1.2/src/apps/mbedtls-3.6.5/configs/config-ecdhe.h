 ...
 */
#ifndef CONFIG_ECDHE_H
#define CONFIG_ECDHE_H
/**
...
/**
 * \def MBEDTLS_SSL_DEFAULT_TICKET_LIFETIME
 *
...
/*
 * Allow untrust CA passed from server.
 */
#define MBEDTLS_TRUST_UNKNOWN_CA

#endif // CONFIG_ECDHE_H