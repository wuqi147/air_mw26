...
/* FILE NAME:  mw_acl.h
 * PURPOSE:
 * It provides the API and definitions for MW ACL.
 *
 * NOTES:
 */
...
/* Definition for ACL action of the port forward behavior. */
#define MW_ACL_ACT_PORT_FW_DEFAULT          0
#define MW_ACL_ACT_PORT_FW_CPU_EXCLUDE      4
#define MW_ACL_ACT_PORT_FW_CPU_INCLUDE      5
#define MW_ACL_ACT_PORT_FW_CPU_ONLY         6
#define MW_ACL_ACT_PORT_FW_DROP             7
