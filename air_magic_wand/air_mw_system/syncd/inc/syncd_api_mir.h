...
/* FILE NAME:  syncd_api_mir.h
 * PURPOSE:
 *      It provides Mirror API functions in syncd.
 *
 * NOTES:
 */

#ifndef _SYNCD_API_MIR_H_
#define _SYNCD_API_MIR_H_
 ...
 * PURPOSE:
 *      Set mirror session and destination port
 *
 * INPUT:
