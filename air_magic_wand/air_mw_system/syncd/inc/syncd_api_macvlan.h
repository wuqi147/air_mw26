...
/* FILE NAME:  syncd_api_macvlan.h
 * PURPOSE:
 *      It provides mac based vlan API functions in syncd.
 *
 * NOTES:
 */

#ifndef _SYNCD_API_MACVLAN_H_
#define _SYNCD_API_MACVLAN_H_
