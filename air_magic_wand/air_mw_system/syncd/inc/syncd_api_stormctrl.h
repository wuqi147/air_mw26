...
/* FILE NAME:  syncd_api_stormctrl.h
 * PURPOSE:
 *      It provides stormctrl API functions in syncd.
 *
 * NOTES:
 */

#ifndef _SYNCD_API_STORMCTRL_H_
#define _SYNCD_API_STORMCTRL_H_
