...
/* FILE NAME:  syncd_api_sec.h
 * PURPOSE:
 *      It provides security API functions in syncd.
 *
 * NOTES:
 */

#ifndef _SYNCD_API_SEC_H_
#define _SYNCD_API_SEC_H_
...
*/
#define SYNCD_MAC_LIMIT_DISABLE (0)
