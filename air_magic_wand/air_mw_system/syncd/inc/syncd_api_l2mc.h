...
/* FILE NAME:  syncd_api_l2mc.h
 * PURPOSE:
 *      It provides L2MC API functions in syncd.
 *
 * NOTES:
 */

#ifndef _SYNCD_API_L2MC_H_
#define _SYNCD_API_L2MC_H_
 ...
 * PURPOSE:
 *      process L2MC MAC entry request from DB.
 *
 * INPUT:
 *      ptr_api_arg --  porinter to API arguments
 *
