...
#define MSTP_INSTANCE_INVALID(instance)  ((instance) > 4095)
#define MSTP_VLAN_INVALID(vid)           ((vid) > 4094)
#define MSTP_REVISION_INVALID(revision)  ((revision) > 0xffff)
...
#define STP_DEFAULT_PORT_PATH_COST 2000
