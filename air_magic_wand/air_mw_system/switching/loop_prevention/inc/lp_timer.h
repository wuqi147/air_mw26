...
/* FILE NAME:  lp_timer.h
 * PURPOSE:
 *      This file defines the data structure for loop prevention timer.
 *
 * NOTES:
 */
#ifndef LP_TIMER_H
 ...
 */
#define LP_TIMER_NAME                   "lpTmr"
#define LP_TIMER_PERIOD                 (1000)
#define LP_BLOCK_PERIOD                 (30000)
#define LP_FLOW_CONTROL_RESUME_TIME     (3)
