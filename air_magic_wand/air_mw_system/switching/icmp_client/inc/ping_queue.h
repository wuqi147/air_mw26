...
/* FILE NAME:  ping_queue.h
 * PURPOSE:
 *      It provides ping internal queue functions.
 *
 * NOTES:
 */

#ifndef _PING_QUEUE_H_
#define _PING_QUEUE_H_
...
*/
#define PING_QUEUE_DEBUG_LEVEL 0

#define PING_QUEUE_CLI         "PIN"
#define PING_QUEUE_LEN         AIR_MAX_PING_QUEUE_LEN
#define PING_QUEUE_TIMEOUT     (0xFFFFFFFF)
#define PING_ACCEPTMBOX_SIZE   (4)
 ...
 */
MW_ERROR_NO_T
ping_queue_getData(const UI8_T in_t_idx,
