...
#define VLOG_EMER(...)  MW_LOG_ERROR(STP, __VA_ARGS__)
#define VLOG_ERR(...)   MW_LOG_ERROR(STP, __VA_ARGS__)
#define VLOG_WARN(...)  MW_LOG_WARN(STP, __VA_ARGS__)
#define VLOG_INFO(...)  MW_LOG_INFO(STP, __VA_ARGS__)
#define VLOG_DBG(...)   MW_LOG_DEBUG(STP, __VA_ARGS__)
