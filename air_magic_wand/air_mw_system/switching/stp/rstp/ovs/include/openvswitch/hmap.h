...
/* For fixing 'for' loop initial declarations. It is only allowed in C99 or C11
   mode */
#define HMAP_FOR_EACH_WITH_HASH(NODE, MEMBER, HASH, HMAP)                     \
    INIT_MULTIVAR(NODE, MEMBER, hmap_first_with_hash(HMAP, HASH),             \
                       struct hmap_node);                                     \
    for (;                                                                    \
...
#define HMAP_FOR_EACH(NODE, MEMBER, HMAP) \
    INIT_MULTIVAR(NODE, MEMBER, hmap_first(HMAP), struct hmap_node);          \
...
#define HMAP_FOR_EACH_CONTINUE(NODE, MEMBER, HMAP) \
    INIT_MULTIVAR_EXP(NODE, MEMBER, hmap_next(HMAP, &(NODE)->MEMBER),         \
                        struct hmap_node, (void) 0);                          \
