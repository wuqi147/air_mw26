...
/* FILE NAME:   erps_config_customer.h
 * PURPOSE:
 *      Configure ERPS.
 * NOTES:
 *
...
#ifndef ERPS_CONFIG_CUSTOMER_H
#define ERPS_CONFIG_CUSTOMER_H
...
*/
const UI8_T *
erps_config_getPortSettingsArray(void);
...
*/
UI32_T
erps_config_getPortSettingsArraySize(void);
