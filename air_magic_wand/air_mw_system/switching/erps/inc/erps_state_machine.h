...
/* FILE NAME:  erps_state_machine.h
 * PURPOSE:
 *      This file defines the data structure for ERPS state machine.
 *
 * NOTES:
 */
#ifndef ERPS_STATE_MACHINE_H
#define ERPS_STATE_MACHINE_H
