...
/* FILE NAME:  igmp_snoop_cmd.h
 * PURPOSE:
 *      This file defines the data structure for IGMP snooping commands.
 *
 * NOTES:
 */
#ifndef IGMP_SNOOP_CMD_H
#define IGMP_SNOOP_CMD_H
