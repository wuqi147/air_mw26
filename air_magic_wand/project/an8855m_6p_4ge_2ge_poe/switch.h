 ...
 */
/* System Description */
#define AIR_DEFAULT_SYSTEM_NAME     "AN8855M_6P_4GE_2GE_POE"

/* System Port Info */
#define AIR_MAX_PORT_NUM            (6)
#define AIR_MAX_PORT_BITMAP         (0x7E)

/* System Trunk Group Info */
#define AIR_MAX_TRUNK_GROUP         (2)

/* System Trunk Group Member Info */
#define AIR_MAX_TRUNK_MEMBER_NUM    (4)
...
#define MW_TASK_PRIORITY_DB             (configLWIP_TASK_PRIORITY - 1)
...
/* DB Information */
#define AIR_MAX_DB_REQUEST_LEN      (64)
#define AIR_MAX_DB_STACK_SIZE       (404)

/* MQTT Information */
#define AIR_MAX_MQTT_QUEUE_LEN      (16)
#define AIR_MAX_MQTT_QUEUE_TIMEOUT  (50)
#define AIR_MAX_MQTT_STACK_SIZE     (304)
#define AIR_MAX_MQTT_LOCK_TIME      (50)
#define AIR_MAX_MQTT_KEEP_ALIVE     (5)

/* System Management Information */
#define AIR_MAX_SYS_MGMT_QUEUE_LEN            (16)
#define AIR_MAX_SYS_MGMT_DHCP_RATE_PER_SEC    (40)

/* DHCP Snooping Information */
#define AIR_MAX_SNP_PKT_QUEUE_LEN        (16)
#define AIR_MAX_SNP_DB_QUEUE_LEN         (16)
...
/* Ping Information*/
#define AIR_MAX_PING_QUEUE_LEN      (8)
...
#endif
#define AIR_IGMP_MAX_L2MC_ENTRY_NUM (32)
#define AIR_MAX_IGMP_STACK_SIZE     (404)
#define AIR_MAX_IGMP_DB_QUEUE_LEN   (32)
#define AIR_MAX_IGMP_PKT_QUEUE_LEN  (PBUF_POOL_SIZE)

/* LLDP Information */
#define LLDP_QUEUE_LENGTH          (32+10+10)
...
#define AIR_MAX_LP_DB_QUEUE_LEN     (16)
#define AIR_MAX_LP_PKT_QUEUE_LEN    (PBUF_POOL_SIZE)

/* STP Information */
#define STP_QUEUE_LENGTH_PTK       (32)
#define STP_QUEUE_LENGTH_DB        (32)
#undef  AIR_SUPPORT_STP_AUTO_COST
#undef  AIR_SUPPORT_STP_UNIFIED_SA
#undef  AIR_SUPPORT_STP_CLEAR_MULTICAST
#define MSTP_INSTANCE_MAX_NUM       (2)

/* Syncd Information*/
#define AIR_MAX_SYNCD_STACK_SIZE    (512)
#define AIR_MAX_SYNCD_TMR_PS        (500)

/* System Managemnt Information */
#define AIR_MAX_SYSMGMT_STACK_SIZE    (420)

/* SFP Information */
#ifdef AIR_SUPPORT_SFP_WITH_THREAD
#define SFP_TASK_STACK_SIZE (384)
#define SFP_MSG_QUEUE_LENGTH (5)
#endif
#define SFP_MODULE_INFO_MAX_NUM (1)

/* Firmware Update Web Page Info */
#define AIR_WEBPAGE_UPGRADE_TIME    (140)

/* Definition for ACL ENTRY ID */
#define MW_MAX_NUM_OF_ACL_ENTRY             (128)

/* Definition for static ACL IDs. */
#define MW_ACL_ID_STATIC_MAX                (MW_ACL_ID_STATIC_LAST - 1)

/* MAC management */
#define AIR_MAX_PER_WEBPAGE_DYNAMIC_MAC_ADDRESS_ENTRY_NUM       (32)
#define AIR_MAX_PER_REQUESTED_DYNAMIC_MAC_ADDRESS_ENTRY_NUM     (8)
 ...
 * UNTAG_LOW and UNTAG need be in the same 1-sub-block.
 */
typedef enum
{
...
#if !defined(AIR_SUPPORT_HTTPD) && defined(AIR_SUPPORT_CLI)
#define GDMPSRAM_DATA_EX __attribute__((section (".gdmpdata")))
#define GDMPSRAM_BSS_EX  __attribute__((section (".gdmpbss")))
#else
